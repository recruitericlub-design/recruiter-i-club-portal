...
export async function generateMetadata({
  ...
  return {
    ...
    keywords: isUk
      ? [
          "найм іноземців в штат україна 2026",
          "дозвіл на застосування праці іноземців ДЦЗ",
          "робоча віза D-04 україна",
          "зварювальники з узбекистану",
          "робітники з індії непалу бангладеш",
          "стаття 23 мобілізація іноземні громадяни",
          "підбір лінійного персоналу для заводів",
          "аутстафінг персоналу україна",
          "оператори чпк будівельники швачки",
          "Recruiter I Club",
        ]
      : isRu
      ? [
          "найм иностранцев в штат украина 2026",
          "разрешение на работу иностранцев гцз украина",
          "рабочая виза D-04 украина",
          "сварщики из узбекистана",
          "рабочие из индии непала бангладеш",
          "статья 23 освобождение от мобилизации иностранцы",
          "подбор персонала для производств украина",
          "прямой найм иностранных рабочих в штат",
          "операторы чпу строители швеи",
          "Recruiter I Club",
        ]
      : [
          "hire foreign workers Ukraine 2026",
          "Ukraine work permit D-04 visa",
          "welders from Uzbekistan India",
          "industrial recruitment agency Ukraine",
          "Article 23 mobilization exemption foreign workforce",
          "legal manufacturing staffing Ukraine",
          "Recruiter I Club international recruitment",
        ],
