...
export const Navbar: React.FC<NavbarProps> = ({ locale, messages }) => {
  ...
  const navLinks = [
    ...
    { href: "#calculator", label: messages.nav?.calculator || "�����������" },
    { href: "#industries", label: messages.nav?.industries || "�����" },
    { href: "#candidates", label: messages.nav?.candidates || "���������" },
    { href: "#faq", label: messages.nav?.faq || "FAQ" },
  ];

  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-50 transition-all duration-300 backdrop-blur-xl bg-slate-950/85 border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden lg:flex items-center gap-4">
              ...
              >
                <span>{messages.nav?.orderWorkers || "�������� ��������"}</span>
